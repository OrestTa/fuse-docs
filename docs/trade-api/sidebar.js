module.exports = [
  { type: 'doc', id: 'trade-api/intro' },
  {
    type: 'category',
    label: 'Price',
    link: { type: 'doc', id: 'trade-api/price' },
    items: [
      {
        type: 'doc',
  ...
  },
  {
    type: 'category',
    label: 'Price Change',
    link: { type: 'doc', id: 'trade-api/price-change' },
    items: [
      {
        type: 'doc',
  ...
  },
  {
    type: 'category',
    label: 'Stats',
    link: { type: 'doc', id: 'trade-api/stats' },
    items: [
      {
        type: 'doc',
  ...
  },
  {
    type: 'category',
    label: 'Swap',
    link: { type: 'doc', id: 'trade-api/swap' },
    items: [
      {
        type: 'doc',
  ...
  },
  {
    type: 'category',
    label: 'Tokens',
    link: { type: 'doc', id: 'trade-api/tokens' },
    items: [
      {
        type: 'doc',
